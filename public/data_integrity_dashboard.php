        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    ...
                    <a href="fix_pending_paid_citations.php" class="btn btn-warning">
            ...
            foreach ($issues['mismatched_status'] as $row) {
                echo "<tr>";
                echo "<td><a href='view_citation.php?id={$row['citation_id']}'>{$row['ticket_number']}</a></td>";
                ...
                echo "<td><a href='fix_pending_paid_citations.php' class='btn btn-sm btn-primary btn-action'>Fix</a></td>";
                echo "</tr>";
            }
            ...
            foreach ($issues['orphaned_payments'] as $row) {
                ...
                echo "<td><button class='btn btn-sm btn-danger btn-action'>Investigate</button></td>";
                echo "</tr>";
            }
            $tableRows = ob_get_clean();
            ...
            foreach ($issues['stale_pending'] as $row) {
                ...
                echo "<td><a href='pending_print_payments.php' class='btn btn-sm btn-primary btn-action'>Finalize</a></td>";
                echo "</tr>";
            }
            $tableRows = ob_get_clean();
